            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td class="auto-style27">Selecione Consulta:
                        ...
                        <br />
                        <br />
                        Seleccione una Policlinica:
                        <asp:DropDownList ID="DdlPoliclinica" runat="server" Height="16px" Width="224px" OnSelectedIndexChanged="DdlPoliclinica_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
            ...
            <asp:Label ID="LblError" runat="server" ForeColor="Red"></asp:Label>
                ...
                <tr>
                    ...
                    <td class="auto-style19">
                        <asp:GridView ID="GvSolicitudes" runat="server" Width="535px" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" AllowPaging="True" OnPageIndexChanging="GvSolicitudes_PageIndexChanging">
                            <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />
                            <PagerStyle BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Left" />
                            <RowStyle BackColor="White" ForeColor="#003399" />
